...
import { Briefcase, ArrowLeft, Grid3X3, List, SortAsc, SortDesc } from 'lucide-react'
...
function CategoryJobs() {
  ...
  // Get category name from param
  const categoryName = decodeURIComponent(category) || ''
  const categoryDisplayName = categories.find(c => c.toLowerCase() === categoryName.toLowerCase()) || categoryName
  ...
  // Apply sorting
  const sortedJobs = sortJobs(categoryJobs, sortBy)
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex-1 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">{categoryDisplayName} Jobs</h1>
            <p className="text-gray-400">{categoryJobs.length} jobs found</p>
          </div>
        </div>
      </motion.div>
        ...
        {categoryJobs.length > 0 ? (
          ...
          >
            ...
            <p className="text-gray-400 mb-6">
              There are currently no jobs available in the {categoryDisplayName} category.
            </p>
      ...
      {categoryJobs.length === 0 && (
        ...
        >
          <h3 className="text-lg font-semibold text-white mb-4">Explore Other Categories</h3>
